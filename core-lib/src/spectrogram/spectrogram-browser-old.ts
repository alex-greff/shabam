import { ComputeSpectrogramDataOptions, SpectrogramData } from "../fingerprint/types";
import { config } from "../configuration";
import { isBrowser } from "browser-or-node";
import { assert } from "tsafe";

// TODO: remove, browser versions of the library are no longer needed.
...
export async function computeSpectrogramData(
  ...
  const data = new Float32Array(numWindows * frequencyBinSize);
