...
export const generateFingerprint: FingerprintGeneratorFunction = async (
  ...
  throw "TODO: remove this file";
  // const defaultOptions: FingerprintConfig = {
  ...
  // const numWindows = spectrogramData.numWindows;
  // const numFrequencies = spectrogramData.numBuckets;
