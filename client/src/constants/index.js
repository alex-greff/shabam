...
export const FINGERPRINT_PARITION_AMOUNT = 15; // [1, infinity)
export const FINGERPRINT_PARITIION_CURVE = 50; // (1, infinity)
export const FINGERPRINT_SLIDER_WIDTH = 3; // num windows on each side
export const FINGERPRINT_THRESHOLD_MULTIPLIER = 0.5; // 0: everything passes, 1: no weight, (at least) >255: nothing passes
export const FINGERPRINT_FREQ_PASS_PERCENT = 0.5; // [0, 1]
