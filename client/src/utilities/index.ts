 ...
 * @param elSel (Optional) The element or selector for the element. If not 
 * given then the root is selected.
 */
export const saveCSSProperty = (
  propertyName: string,
  propertyValue: string,
  elSel?: HTMLElement | string
) => {
 ...
 * given then the root is selected.
 */
export const removeCSSProperty = (
  propertyName: string,
  elSel?: HTMLElement | string
) => {
  // Serialize the input element/query selector/none
